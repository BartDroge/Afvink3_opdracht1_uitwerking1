...
public class Race extends JFrame implements ActionListener {
    ...
    private void startRace(Graphics g) {
        ...
        g.fillRect(lengte+11, 0, 3, 100);
        Paard h1 = new Paard("Rood",Color.red);
        Paard h2 = new Paard("Blauw",Color.BLUE);
        Paard h3 = new Paard("Groen",Color.GREEN);
        Paard h4 = new Paard("Cyan",Color.cyan);
        Paard h5 = new Paard("Oranje",Color.ORANGE);
        /**(6) Creatie van 4 paarden
        ...
        if (h5.getAfstand() > lengte) {
            JOptionPane.showConfirmDialog(null, h5.getNaam() + " gewonnen!");
        }
    }
